# bot.py - FINAL BOX B STRATEGY - COMMAND CONTROL
...
print(f"SETTINGS -> Timeframe: {TIMEFRAME}, Period: {PERIOD}, Width: {CHANNEL_WIDTH}%")
...
for sym in ALL_STOCKS:
    try:
        df = yf.download(sym, period=PERIOD, interval=TIMEFRAME, progress=False, auto_adjust=True, timeout=15)
        if len(df) < 150:
